...
CREATE INDEX IF NOT EXISTS cardano_transactions_hash ON cardano_transactions USING BTREE(hash) INCLUDE (block_no);
...
CREATE INDEX IF NOT EXISTS cardano_txo_stake_credential ON cardano_txo USING BTREE(stake_credential) INCLUDE (transaction_hash, index, value);
